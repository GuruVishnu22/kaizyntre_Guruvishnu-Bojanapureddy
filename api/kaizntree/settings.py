...
SECRET_KEY = 'django-insecure-s%=w+kpn^@iv*7vqo3_d*l!x8s2sowqbr#vn01ds!urmj#ebh3'
...
# CORS_ALLOWED_ORIGINS = ["http://localhost:3000","http://192.168.1.103:3000"] # Add this line
